...
function About() {
    return(
        <div className="">
            ...
            <Image src="banner.jpg" alt="" className="w-28 sm:w-36 md:w-48 sm:mt-10 lg:w-56 ml-10 lg:mt-12 rounded-lg"/>
            ...
            <div className="ml-40 flex sm:ml-48 sm:-mt-1 md:ml-64 lg:ml-72 mt-2 gap-2">
               <Link href="https://mail.google.com"><Image src="Gmail.jpg" alt="" className="w-10"/></Link>
               <Link href="https://www.linkedin.com/in/saud-zubair-955a98175/"><Image src="Linkenden.jpg" alt="" className="w-10"/></Link>
               <Link href="https://github.com/Saud840"><Image src="github.jpg" alt="" className="w-10"/> </Link>
            </div>
            </div>
